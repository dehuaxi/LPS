    ...
    var barcode = {
        ...
        code128: {
            ...
            getDigit: function (code) {
                ...
                // linHaiScan each characters
                for (i = 0; i < code.length; i++) {
                    if (tableB.indexOf(code.charAt(i)) == -1) return ("");
                }

                // linHaiScan firsts characters : start with C table only if enought numeric
                ...
                while (i < code.length) {
                    if (!tableCActivated) {
                        j = 0;
                        // linHaiScan next character to activate C table if interresting

...
function findByLimit(currentPage) {
    ...
    var createDate=$("#input_createDate").val();
                ...
                if (data.data != null) {
                    ...
                    for (var i = 0; i < record.length; i++) {
                        ...
                        if(record[i].good!=null){
                            ...
                            if(record[i].good.factory!=null){
                                factoryname=record[i].good.factory.factoryname;
                            }
                        }
                        if(record[i].route!=null){
                            routename=record[i].route.routename;
                        }
                        var str = "<tr><td>" + goodcode +"</td>"+
                            ...
                            "<td>" + timeFormat(record[i].overtime) +"</td></tr>";

        ...
        success:function (data){
            if(data.code==0){
                for(var i=0;data.data.length;i++){
                    $("#select_warehouseId").append("<option value='"+data.data[i].id+"'>"+data.data[i].warehousename+"</option>")
                }
            }else {
                alert(data.msg);
            }
...
function findByLimit(currentPage) {
    ...
    var pakcState=$("#select_packState").val();
            ...
            if(data.code==0){
                ...
                if (data.data != null) {
                    ...
                    for (var i = 0; i < record.length; i++) {
                        ...
                        if(record[i].warehouse!=null){
                            warehouseName=record[i].warehouse.warehousename;
                        }
                        var str= "<tr><td>" + goodcode +"</td>"+
                            ...
                            "<td>" + record[i].plancount +"</td>"+
                            "<td>" + record[i].oneboxcount +"</td>"+
                            "<td>" + record[i].boxcount +"</td>"+
                            "<td>" + record[i].packstate +"</td>"+
                            "<td>" + warehouseName +"</td>"+
                            "<td>" + timeFormat(record[i].createtime) +"</td></tr>";
